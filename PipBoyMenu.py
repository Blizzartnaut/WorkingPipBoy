...
################################################################################
## Form generated from reading UI file 'PipBoyMenuui.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.FMSe = QPushButton(self.RADIO)
        self.FMSe.setObjectName(u"FMSe")
        self.FMSe.setGeometry(QRect(10, 60, 191, 61))
        self.AMSe = QPushButton(self.RADIO)
        self.AMSe.setObjectName(u"AMSe")
        self.AMSe.setGeometry(QRect(10, 130, 191, 61))
        self.HAMSe = QPushButton(self.RADIO)
        self.HAMSe.setObjectName(u"HAMSe")
        self.HAMSe.setGeometry(QRect(10, 200, 191, 61))
        self.GMRCSe = QPushButton(self.RADIO)
        self.GMRCSe.setObjectName(u"GMRCSe")
        self.GMRCSe.setGeometry(QRect(10, 270, 191, 61))
        self.SeekL = QPushButton(self.RADIO)
        self.SeekL.setObjectName(u"SeekL")
        self.SeekL.setGeometry(QRect(320, 60, 191, 61))
        self.SeekR = QPushButton(self.RADIO)
        self.SeekR.setObjectName(u"SeekR")
        self.SeekR.setGeometry(QRect(540, 60, 191, 61))
        ...
        self.ShutDown = QPushButton(self.config)
        self.ShutDown.setObjectName(u"ShutDown")
        self.ShutDown.setGeometry(QRect(610, 10, 171, 51))
        self.ReBoot = QPushButton(self.config)
        self.ReBoot.setObjectName(u"ReBoot")
        self.ReBoot.setGeometry(QRect(610, 70, 171, 51))
        self.label_2 = QLabel(self.config)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(140, 10, 251, 41))
        self.TimeREM = QLabel(self.config)
        self.TimeREM.setObjectName(u"TimeREM")
        self.TimeREM.setGeometry(QRect(4, 10, 131, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Warn5.setText("")
        self.FMSe.setText(QCoreApplication.translate("MainWindow", u"FM Search", None))
        self.AMSe.setText(QCoreApplication.translate("MainWindow", u"AM Search", None))
        self.HAMSe.setText(QCoreApplication.translate("MainWindow", u"HAM Search", None))
        self.GMRCSe.setText(QCoreApplication.translate("MainWindow", u"GMRC Search", None))
        ...
        self.ReBoot.setText(QCoreApplication.translate("MainWindow", u"Reboot", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Battery Life Remaining", None))
        self.TimeREM.setText("")
